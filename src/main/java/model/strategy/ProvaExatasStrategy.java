...
// Estratégia de avaliação para disciplinas de Exatas: bônus concedido pelo nível de conhecimento do jogador
public class ProvaExatasStrategy implements EstrategiaAvaliacao {
    @Override
    public double calcularNota(int acertos, int totalPerguntas, Jogador jogador, int dificuldade) {
        ...
        double bonus = (jogador.getNivelConhecimento() > 70) ? 1.0 : 0.0;
